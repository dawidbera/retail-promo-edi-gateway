...
namespace RetailPromoEdiGateway.Infrastructure.Persistence
{
    /// <summary>
        ...
        private static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PurchaseOrderLine>().HasData(
                new PurchaseOrderLine
                {
                    ...
                    ProductName = "Makaron Spaghetti 500g",
                    OrderedQty = 10000,
                    ConfirmedQty = 0,
                ...
                new PurchaseOrderLine
                {
                    ...
                    ProductName = "Oliwa z Oliwek Extra Vergine 1L",
                    OrderedQty = 5000,
                    ConfirmedQty = 0,
                    RequestedDate = new DateTime(2026, 05, 28, 0, 0, 0, DateTimeKind.Utc),
                    Status = PurchaseOrderLineStatus.Pending
                ...
                new PurchaseOrderLine
                {
                    ...
                    ProductName = "Zestaw Narzędzi Ogrodowych",
                    OrderedQty = 1500,
                    ConfirmedQty = 0,
