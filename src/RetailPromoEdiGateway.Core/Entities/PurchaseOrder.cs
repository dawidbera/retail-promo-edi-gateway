...
{
    /// <summary>
    /// Represents a promotional purchase order (PO) issued to a supplier for a specific campaign.
    /// </summary>
    public class PurchaseOrder
    {
        ...
        /// <summary>
        /// Reference to the associated promotional campaign.
        /// </summary>
        public Guid CampaignId { get; set; }

        /// <summary>
        /// Navigation property to the associated promotional campaign.
        /// </summary>
    ...
    /// <summary>
    /// Represents the processing status of a promotional purchase order.
    /// </summary>
