...
namespace RetailEdiGateway.Infrastructure.Persistence
{
    ...
    public class ApplicationDbContext : DbContext, IApplicationDbContext
    {
        ...
        /// <summary>
        /// Gets or sets the set of campaigns.
        /// </summary>
        public DbSet<Campaign> Campaigns => Set<Campaign>();

        /// <summary>
        /// Gets or sets the set of suppliers.
        /// </summary>
        public DbSet<Supplier> Suppliers => Set<Supplier>();

        /// <summary>
        /// Gets or sets the set of purchase orders.
        /// </summary>
        public DbSet<PurchaseOrder> PurchaseOrders => Set<PurchaseOrder>();

        /// <summary>
        /// Gets or sets the set of purchase order lines.
        /// </summary>
        public DbSet<PurchaseOrderLine> PurchaseOrderLines => Set<PurchaseOrderLine>();

        /// <summary>
        /// Gets or sets the set of EDI transactions.
        /// </summary>
        public DbSet<EdiTransaction> EdiTransactions => Set<EdiTransaction>();

        /// <summary>
        /// Gets or sets the set of warehouse slots.
        /// </summary>
